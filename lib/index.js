...
function init(options) {
    ...
    var bookConfig = config.get(bookRoot);

    outputFile = options.outputfile || bookConfig.outputfile ;

    bookCatalog = options.bookcatalog || bookConfig.catalog ;
    ignoreFolders = options.ignorefolders || bookConfig.ignorefolders;
    unchangedCatalog = options.unchangedcatalog || bookConfig.unchangedcatalog ;
    bookName = options.bookname || bookConfig.name;
