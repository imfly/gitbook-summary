...
program
    ...
    .option("-r, --bookroot", "root folder, default is `.`")
    .option("-n, --bookname", "book name, default is `Your Book Name`.")
    .option("-c, --bookcatalog", "catalog folders included book files, default is `all`.")
    .option("-i, --ignorefolders", "ignore folders that be excluded, default is `[]`.")
    .option("-u, --unchangedcatalog", "unchanged catalog like `request.js`, default is `[]`.")
